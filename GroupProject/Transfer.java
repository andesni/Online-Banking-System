...
public class Transfer extends UserDetail {
    ...
    final String Path2 = "Userhistory.txt";
    ...
    public double myBank() throws IOException, InterruptedException {
        ...
        try {
            if (myacc1 == myacc && String.valueOf(myacc1).length() == 9) {
                ...
                int choice = JOptionPane.showConfirmDialog(null, "Are you Sure you want to transfer GHS" + amount
                        + " to " + getOthername() + "'s account?.\nClick OK to Continue or Cancel to abort");
                if (choice == JOptionPane.OK_OPTION) {
                        ...
                        if (myAccnum == Long.parseLong(data[4])) {
                            ...
                            if (pind == Integer.parseInt(data[3])) {
                                ...
                                if (amount1 > 0) {
                                    ...
                                    hist.println(date + "," + time + "," + myAccnum + "," + creation.getTransactionId()
                                            + ", DEBIT: A debit transaction of GHS" + amount + " has been sent to "
                                            + nameAcc + "'s account" + "{" + acct + "}");
                                    hist.close();
                                    // int end = JOptionPane.showConfirmDialog(null,"Would you like to proceed with
                                    // your banking or exit our system?");
                                    // if(end == JOptionPane.YES_OPTION){
                                    // login.login();
                                    // }else {
                                    // JOptionPane.showMessageDialog(null,"Your satisfaction is our priority. Thank
                                    // you for banking with us. Goodbye!");
                                    // }
                                } else {
                                    ...
                                    if (confirm == JOptionPane.YES_OPTION) {
                                        ...
                                        JOptionPane.showMessageDialog(null,
                                                "Your satisfaction is our priority. Thank you for banking with us. Goodbye!");
                                    }
                                }
                            } else {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Thank you for trusting us with your financial needs. Have a pleasant day!");
                }

            } else {
                JOptionPane.showMessageDialog(null,
                        "The account number must consist of exactly 9 digits. Please check and try again.");
                OtherBank();
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null,
                        ...
                        if (data[4].equals(Long.toString(myAccnum))) {
                            ...
                            if (data[3].equals(Integer.toString(pind))) {
                                ...
                                if (amount1 > 0) {
                                    ...
                                    // login.login();
                                    // }else{
                                    // JOptionPane.showMessageDialog(null, "Thank you for trusting us with your
                                    // financial needs. Have a pleasant day!");
                                    // }
                                } else {
                                    JOptionPane.showMessageDialog(null, "The balance in your account is 0");
                                    // int confirm = JOptionPane.showConfirmDialog(null,"Would you like to proceed
                                    // with your banking or exit our system?");
                                    // if (confirm == JOptionPane.YES_OPTION){
                                    // Login login = new Login();
                                    // login.login();
                                    // }else {
    ...
    public void menuTransfer() throws IOException, InterruptedException {
        ...
        int choice = JOptionPane.showConfirmDialog(null, com, "SELECT AN OPTION\t", JOptionPane.OK_CANCEL_OPTION,

...
public class Prime {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            ...
            ProcessBuilder Py = new ProcessBuilder("python",
                    "/Users/sunmi/Desktop/Coding/Codes/GroupProject/Welcome.py");
            Py.directory(new File("/Users/sunmi/Desktop/Coding/Codes/GroupProject/"));
            // START TO READ
        ...
        try {
            do {
                int k = JOptionPane.showConfirmDialog(null,
                        "Welcome to Prime Bank. We're committed to providing you with the best banking experience possible.\nDo you already have an account with us? Please enter 'yes' or 'no' to create a new account.");

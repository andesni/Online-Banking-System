...
public class Creation {
    ...
    public long setAccNum(long accNum) throws FileNotFoundException {
        ...
        accNum = rand.nextInt(999999999) + 222;
    ...
    public void StoreData() throws IOException {
        ...
        write.println(getName() + "," + getLastName() + "," + getPhoneNum() + "," + getPin() + "," + getAccnum() + ","
                + getAmount());
        write.close();
    ...
    public void main() throws IOException, InterruptedException {
        ...
        int k = JOptionPane.showConfirmDialog(null,
                "IS YOUR DETAILS CORRECT? IF ENTER YES TO CONTINUE, NO TO CREATE ACCOUNT");
